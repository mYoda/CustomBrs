...
const wchar_t kChromeExe[] = L"Alfa.exe";
...
const wchar_t kChromeNewExe[] = L"new_Internet.exe";
const wchar_t kChromeOldExe[] = L"old_Internet.exe";
...
const wchar_t kGoogleChromeInstallSubDir1[] = L"Alfa";
const wchar_t kGoogleChromeInstallSubDir2[] = L"Alfa";
