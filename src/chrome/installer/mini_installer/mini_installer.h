...
#else
const wchar_t kApRegistryKeyBase[] = L"Software\\Alfa";
const wchar_t kUninstallRegistryKey[] =
    L"Software\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Alfa";
const wchar_t kCleanupRegistryKey[] = L"Software\\Alfa";
#endif
