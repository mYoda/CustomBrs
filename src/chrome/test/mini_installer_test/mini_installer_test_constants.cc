...
#else
const wchar_t kChromeAppDir[] = L"Alfa\\Application\\";
const wchar_t kChromeBuildType[] = L"Alfa";
const wchar_t kChromeFirstRunUI[] = L"Welcome to Alfa";
const wchar_t kChromeLaunchShortcut[] = L"Chromium.lnk";
const wchar_t kChromeUninstallShortcut[] = L"Uninstall Chromium.lnk";
const wchar_t kChromeUninstallDialogName[] = L"Uninstall Alfa";
#endif
const wchar_t kBrowserTabName[] = L"New Tab - Alfa";
...
const wchar_t kChromeProductName[] = L"Alfa";
...
const wchar_t kInstallerWindow[] = L"Alfa Installer";
